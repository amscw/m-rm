...
STM32F30x_StdPeriph_Driver/cmsis/gcc_ride7/%.o: ../STM32F30x_StdPeriph_Driver/cmsis/gcc_ride7/%.S
	...
	arm-none-eabi-gcc -mcpu=cortex-m4 -mthumb -Og -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -ffreestanding -fno-move-loop-invariants -Wall -Wextra  -g3 -x assembler-with-cpp -DDEBUG -DUSE_FULL_ASSERT -DTRACE -DOS_USE_TRACE_SEMIHOSTING_DEBUG -DSTM32F30X -DUSE_STDPERIPH_DRIVER -I"S:\puma\firmware\m-rm\STM32F30x_StdPeriph_Driver\cmsis\Include" -I"S:\puma\firmware\m-rm\STM32F30x_StdPeriph_Driver\inc" -I"S:\puma\firmware\m-rm\include" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "$@" "$<"
